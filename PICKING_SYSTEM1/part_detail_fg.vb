...
loop_check_open_printer:
        If Bluetooth_Connect_MB200i(stInfoSet, pin, pinlen) = True Then
            ...
            Dim qrdetailSupply As String = "SUP " & Module1.FG_LINE & " " & Module1.FG_CUS_ORDER_ID & " " & itemStrqr & " " & Module1.FG_QTY.Substring(6) & " " & Module1.A_USER_ID & " " & id_pick_log_supply & " " & date_sup & " " & time_sup
